...
current_version = '1.0'  # line:53
AUTHFILE = Path('authkey.config')  # line:54
def checkforupdates():  # line:55
    print(Fore.BLUE + "Checking for updates...")  # line:56
    new_version = requests.get('https://pastebin.com/raw/QvnRVsYP')  # line:57
    print("The Newest version is : " + new_version.text)  # line:58
    print('Your version is : ' + current_version)  # line:59
    latest_version = new_version.text  # line:60
    if latest_version == current_version:  # line:61
        print('You are up to date ! :)')  # line:62
        time.sleep(3)  # line:63
    else:  # line:64
        print('You are not up to date ! :(')  # line:65
        wants_update = input("Do you want to download the latest version ?")  # line:66
        if wants_update == "yes":  # line:67
            print('Downloading ...')  # line:68
            new_version = requests.get('https://pastebin.com/raw/jBeBhhne')  # line:69
            latest_version_downloaded = new_version.text  # line:70
            print(latest_version_downloaded)  # line:71
            webbrowser.open_new_tab(latest_version_downloaded)  # line:72
        else:  # line:73
            print("OK starting programme !")  # line:74
requests.packages.urllib3.disable_warnings()  # line:76
value = 0  # line:77
class api:  # line:78
    name = ownerid = secret = ""  # line:79
    def __init__(self, name, ownerid, secret):  # line:81
        self.name = name  # line:82
        self.ownerid = ownerid  # line:84
        self.secret = secret  # line:86
    session_id = session_iv = ""  # line:88
    def init(self):  # line:90
        self.session_iv = str(uuid4())[:8]  # line:91
        iv = SHA256.new(self.session_iv.encode()).hexdigest()  # line:93
        data = {"type": binascii.hexlify(("init").encode()),
                "name": binascii.hexlify(self.name.encode()),
                "ownerid": binascii.hexlify(self.ownerid.encode()),
                "init_iv": iv}  # line:100
        response = self.post_data(data)  # line:102
        response = encryption.decrypt(response, self.secret,
                                      iv)  # line:104
        if response == "KeyAuth_Disabled":  # line:106
            print("The program key you tried to use doesn't exist")  # line:107
            print("Exiting ...")  # line:108
            time.sleep(3)  # line:109
            sys.exit()  # line:110
        if response == "KeyAuth_Initialized":  # line:113
            print("Initialized")  # line:114
            has_succeeded = 2  # line:115
            return True  # line:116
        else:  # line:117
            print("The program key you tried to use doesn't exist")  # line:118
            print("Exiting...")  # line:119
            time.sleep(3)  # line:120
            sys.exit()  # line:121
    def login(self, key, hwid=None):  # line:126
        if hwid is None: hwid = others.get_hwid()  # line:127
        self.session_iv = str(uuid4())[:8]  # line:129
        iv = SHA256.new(self.session_iv.encode()).hexdigest()  # line:131
        data = {"type": binascii.hexlify(("login").encode()),
                "key": encryption.encrypt(key, self.secret, iv),
                "hwid": encryption.encrypt(hwid, self.secret, iv),
                "name": binascii.hexlify(self.name.encode()),
                "ownerid": binascii.hexlify(self.ownerid.encode()),
                "init_iv": iv}  # line:140
        response = self.post_data(data)  # line:142
        response = encryption.decrypt(response, self.secret,
                                      iv)  # line:144
        if response == "KeyAuth_Valid":  # line:146
            print(Fore.GREEN + "Logged in!")  # line:147
            has_succeeded = 2  # line:148
            checkforupdates()  # line:149
            return True  # line:150
        if response == "KeyAuth_Invalid":  # line:151
            print(Fore.RED + "Key not found!")  # line:152
            print(Fore.RED + "Exiting ...")  # line:153
            time.sleep(3)  # line:154
            sys.exit()  # line:155
        if response == "KeyAuth_InvalidHWID":  # line:158
            print(
                Fore.RED + "This computer doesn't match the computer the key is locked to. If you reset your computer, contact the application owner")  # line:159
            print(Fore.RED + "Exiting...")  # line:161
            time.sleep(3)  # line:162
            sys.exit()  # line:163
        if response == "KeyAuth_Expired":  # line:165
            print(Fore.RED + "This key is expired")  # line:166
            print(Fore.RED + "Exiting...")  # line:168
            time.sleep(3)  # line:169
            sys.exit()  # line:170
        else:  # line:172
            print(Fore.RED + "Application Failed To Connect. Try again or contact application owner")  # line:173
            print(Fore.RED + "Exiting...")  # line:174
            time.sleep(3)  # line:175
            return  # line:176
    def post_data(self, data):  # line:180
        headers = {"User-Agent": "KeyAuth"}  # line:181
        session = requests.Session()  # line:183
        req = session.post("https://keyauth.com/api/", data=data,
                           headers=headers, verify=False)  # line:187
        return req.text  # line:189
class others:  # line:192
    @staticmethod  # line:193
    def get_hwid():  # line:194
        if platform.system() != "Windows":  # line:195
            return "None"  # line:196
        hwid_command = subprocess.Popen("wmic useraccount where name='%username%' get sid", stdout=subprocess.PIPE,
                                        shell=True)  # line:198
        hwid = hwid_command.communicate()[0]  # line:200
        hwid = hwid.split(b'\n')[1].strip()  # line:202
        return hwid.decode()  # line:204
class encryption:  # line:207
    @staticmethod  # line:208
    def encrypt_string(padded, encryption, string):  # line:209
        padded = pad(padded, 16)  # line:210
        encryption_method = AES.new(encryption, AES.MODE_CBC, string)  # line:212
        encrypted_string = encryption_method.encrypt(padded)  # line:214
        return binascii.hexlify(encrypted_string)  # line:216
    @staticmethod  # line:218
    def decrypt_string(hexxed, encryption, encrypted_string):  # line:219
        hexxed = binascii.unhexlify(hexxed)  # line:220
        decryption_method = AES.new(encryption, AES.MODE_CBC, encrypted_string)  # line:222
        hexxed = decryption_method.decrypt(hexxed)  # line:224
        return unpad(hexxed, 16)  # line:226
    @staticmethod  # line:228
    def encrypt(encrypt_this, secret, iv):  # line:229
        try:  # line:230
            secret_method = SHA256.new(secret.encode()).hexdigest()[:32]  # line:231
            iv_method = SHA256.new(iv.encode()).hexdigest()[:16]  # line:233
            return encryption.encrypt_string(encrypt_this.encode(), secret_method.encode(),
                                             iv_method.encode()).decode()  # line:235
        except:  # line:236
            print("Invalid API/Encryption key")  # line:237
            print("Exiting...")  # line:238
            time.sleep(3)  # line:239
            sys.exit()  # line:240
    @staticmethod  # line:243
    def decrypt(response_encrypted, secret, iv):  # line:244
        try:  # line:245
            secret_method = SHA256.new(secret.encode()).hexdigest()[:32]  # line:246
            iv_method = SHA256.new(iv.encode()).hexdigest()[:16]  # line:248
            return encryption.decrypt_string(response_encrypted.encode(), secret_method.encode(),
                                             iv_method.encode()).decode()  # line:250
        except:  # line:251
            print("Invalid API/Encryption key")  # line:252
            print("Exiting ...")  # line:253
            time.sleep(3)  # line:254
            sys.exit()  # line:255
def loginregister():  # line:262
    api_ = api("GiftCard", "KhLn15qU2g",
               "25cc176e3d70dc2c7e395463d6ebe1d11852f7d49df41a8661c38453dcf0fe0b")  # line:263
    os.system('title GIFTCARD++ ^| By GothBoyClique ^| Version 1.0 ^| Login or Register')  # line:264
    print(Fore.GREEN + '''
...
''')  # line:278
    print("\033[90m[\033[90m\033[94m1\033[39m\033[90m]\033[0m Login")  # line:279
    print("\033[90m[\033[90m\033[94m2\033[39m\033[90m]\033[0m Purchase Key")  # line:280
    print("\033[90m[\033[90m\033[94m3\033[39m\033[90m]\033[0m Check Status")  # line:281
    print("   ")  # line:282
    choice = input("Your Choice: ")  # line:283
    if choice == "1":  # line:284
        print("Initializing")  # line:285
        api_.init()  # line:286
        if AUTHFILE.exists():  # line:287
            authfile_exists = True  # line:288
            with AUTHFILE.open()as f:  # line:289
                api_key = f.read()  # line:290
        else:  # line:291
            api_key = input('Enter your key: ')  # line:292
            authfile_exists = False  # line:293
            with AUTHFILE.open('w')as f:  # line:294
                f.write(api_key)  # line:295
    elif choice == "2":  # line:296
        print("Please visit https://sellix.io/GCplus and buy :)")  # line:297
        time.sleep(5)  # line:298
        os.system('cls')  # line:299
        loginregister()  # line:300
    elif choice == "3":  # line:301
        print("THIS FUNCTION IS CURRENTLY DOWN :/")  # line:302
        time.sleep(5)  # line:303
        loginregister()  # line:304
    else:  # line:305
        print("Wrong Input")  # line:306
        os.system('cls')  # line:307
        time.sleep(3)  # line:308
        sys.exit()  # line:309
    api_.login(api_key)  # line:315
loginregister()  # line:318
from PIL import Image, ImageFont, ImageDraw  # line:319
updatenew = urlopen(Request("https://pastebin.com/raw/UCgAGfYT")).read().decode()  # line:322
discord = 'https://discord.gg/63MaEbfvBw'  # line:323
init()  # line:324
...
\033[94m  \____/___/_/     /_/  \____/_/  |_/_/ |_/_____/ /_/   /_/   \033[39m
                            \033[94m V.I.P\033[39m
\033[90m[\033[90m\033[94m+\033[39m\033[90m]\033[0m There is a new update? - {updatenew}
...
\033[90m[\033[90m\033[94m6\033[39m\033[90m]\033[0m PDF Generator
\033[90m[\033[90m\033[94m7\033[39m\033[90m]\033[0m Module Creator
\033[90m[\033[90m\033[94m8\033[39m\033[90m]\033[0m Discord
\033[90m[\033[90m\033[94m9\033[39m\033[90m]\033[0m Website
\033[90m[\033[90m\033[94m10\033[39m\033[90m]\033[0m Credits
\033[90m[\033[90m\033[94m11\033[39m\033[90m]\033[0m Version Info
''')  # line:911
    ...
    if choice == '1':  # line:913
        ...
        print(Fore.BLUE + '|GothBoyClique#2569       |')  # line:953
        print(Fore.BLUE + '|Crypt#9321               |')  # line:954
